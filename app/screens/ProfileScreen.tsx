...
import { Button, ListItem, Screen, Text } from "../IgniteComponents"
  ...
  return (
    <Screen preset="scroll" safeAreaEdges={["top"]} contentContainerStyle={$container}>
      ...
      <View style={$buttonContainer}>
        <Button style={$button} tx="ProfileScreen.reactotron" onPress={demoReactotron} />
        <Text style={$hint} tx={`ProfileScreen.${Platform.OS}ReactotronHint` as const} />
      </View>
      <View style={$buttonContainer}>
